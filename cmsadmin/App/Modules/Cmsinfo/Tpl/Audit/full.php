				...
				<div class="full_content">
					...
					<div class="full_foot">
						<div class="foot_submit">
		        			<form action="/Cmsinfo/Audit/verify" method="post" onsubmit="return chk_verify();">
       					...
       					<div class="foot_undisable">
       						<a href="/Cmsinfo/Audit/undisable?id=<?php if(!empty($news_list['news_id'])): echo $news_list['news_id']; endif; ?>&page=<?php if(!empty($page)): echo $page; endif; ?>" onclick="return chk_undisable();" <?php if($news_list['news_status'] != 2): echo 'style="display:none;"'; endif; ?>><img src="__PUBLIC__/Images/undisable_mini.gif"></a>
       					</div>
       					<div class="foot_back">
       						<a href="/Cmsinfo/Audit/index?page=<?php if(!empty($page)): echo $page; endif; ?>"><img src="__PUBLIC__/Images/back_mini.gif"></a>
       					</div>
       				</div>
				</div>
	       	</fieldset>
