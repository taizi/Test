...
<dl><label>首重金额：</label><input name="pos[price]" id="price" type="text" class="inp200" value="" /></dl>
<dl><label>续重金额：</label><input name="pos[replenish]" id="replenish" type="text" class="inp200" value="" /></dl>
