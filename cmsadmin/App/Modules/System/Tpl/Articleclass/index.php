...
<div id="index_main">
  ...
  <div class="con_right">
       <div class="location">系统管理  > 文章分为 </div>
       <div class="tools"> <a  href="javascript:addClass()" class="btn_blue float" class="btn_red cmd100">新增</a> </div>
       <div >
	           ...
	           <?php foreach ($List as $v){ ?>
			       <tr>
			        ...
			        <td width="240" align="center">
			            <a class="btn_blue float" href="javascript:editClass(<?php echo $v['id'];?>)">编辑</a> 
			            <a class="btn_red float" href="javascript:delClass(<?php echo $v['id'];?>)">删除</a>
			       </td>
			       </tr>
	        <?php }?>       
	        </table>
